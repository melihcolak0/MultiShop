...
namespace MultiShop.Catalog.Services.AboutServices
{
    public class AboutService : IAboutService
    {
        ...
        public async Task<GetAboutDTO> GetAboutByIdAsync(string id)
        {
            ...
            return _mapper.Map<GetAboutDTO>(value);
        }
        ...
        {
            var values = await _aboutCollection.Find(x => x.Status == true).ToListAsync();
            return _mapper.Map<List<ResultAboutDTO>>(values);
        }
        ...
        public async Task ChangeAboutStatusAsync(string id)
        {
            ...
            if (value != null)
            {
                ...
                await _aboutCollection.FindOneAndReplaceAsync(x => x.AboutId == id, value);
            }
        }
    }
}
